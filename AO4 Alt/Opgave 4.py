...
#Opg 4: Beregn distancerne mellem hvert punkt. Gør dette i Excel og husk at sorter så armen ligger øverst.
#Tilret data i data filen så den passer. Kør programmet og skift blot datafilen ud med 1, 2, 3, 4 og noter løsningen.

#Opg 5: Reparerer ruterne (lav det til en cirkel harmonisk cyklus cirkel ting. Sikrer også at ingen svejsearme svejse ved samme punkt på samme tidspunkt

#Opg 6: Beregn objektfunktionsværdien for den nye rute vs den gamle rute.
