...
#
#
#Her implementerer vi en p-median baseret clustering problem
#   Dette betyder at vi ønsker at minimere summen af afstandene mellem dataobjekterne og deres repræsentanter.
#Dette er heltalsprogrammering (IP)
#
#
#---------------------------------#
