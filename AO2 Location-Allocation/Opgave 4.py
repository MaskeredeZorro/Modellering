...
#Vi ønsker her at minimere den totale afstand i sekunder, som en kommune skal køre, for at nå til et sygehus.
#Vi anvender altså her køretiden mellem kommunerne i sekunder.

#Forskel: Vi anvender her en vægt til at vægte hvor vigtig en kommunes kørsels-sekunder er.
#-----------------------------------------------#
...
def buildModel(data: dict) -> pyomo.ConcreteModel():
    ...
    model.obj = pyomo.Objective(expr=sum(model.w[j]*model.travel[i][j] * model.x[i,j] for i in model.kommune for j in model.kommune))
