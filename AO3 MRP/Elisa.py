...
def buildModel(data: dict) -> pyomo.ConcreteModel():
    ...
    model.produktionskapacitetforbrug = data['Produktionskap_forbrug'] #Hvor meget plads tager hvert produkt i produktionen
    model.r = data['r']
...
def displaySolution(model: pyomo.ConcreteModel()):
    ...
    for k in model.products:
        #Lagerniveauer for de forskellige produkter:
