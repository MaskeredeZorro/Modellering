...
def buildModel(data: dict) -> pyomo.ConcreteModel():
    ...
    model.obj = pyomo.Objective(expr=sum(model.p[k][t]*model.batch* model.x[k, t] + model.q[k][t] * model.y[k, t] + model.h[t] * model.s[k, t] for t in model.periods for k in model.products))
